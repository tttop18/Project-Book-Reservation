...
func CreateResponseUser(user models.User) User {
	return User{ID: user.ID, FirstName: user.FirstName, LastName: user.LastName, NationalID: user.NationalID, CreatedAt: user.CreatedAt}
}
...
func UpdateUser(c *fiber.Ctx) error {
	...
	user.NationalID = updateData.NationalID
